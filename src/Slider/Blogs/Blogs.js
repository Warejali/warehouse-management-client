        ...
        <div className='container'>
            <div className='blog-items my-5 bg-success text-white py-5 px-5'>
                ...
                <table className="p-5 border-collapse border border-slate-400 ...">
                    <thead>
                        <tr>
                            <th className="text-center p-3 border border-slate-300 ...">Javascript</th>
                            <th className="text-center border border-slate-300 ...">Node js</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td className="p-3 border border-slate-300 ...">JavaScript is a simple programming language that runs in any browser JavaScript Engine.</td>
                            <td className="p-3 border border-slate-300 ...">Node JS is an interpreter or running environment for a JavaScript programming language that holds many excesses. </td>
                        </tr>
                        <tr>
            ...
            <div className='blog-items my-5 bg-success text-white py-5 px-5'>
                ...
                <table className="p-5 border-collapse border border-slate-400 ...">
                    <thead>
                        <tr>
                            <th className="text-center p-3 border border-slate-300 ...">SQL</th>
                            <th className="text-center border border-slate-300 ...">NOSQL</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td className="p-3 border border-slate-300 ...">SQL stands for Structured Query Language which is basically a language used by databases.</td>
                            <td className="p-3 border border-slate-300 ...">NoSQL databases are non-tabular databases and store data differently than relational tables</td>
                        </tr>
                        <tr>
            ...
            <div className='blog-items my-5 bg-success  text-white py-5 px-5'>
                <h3 className='text-2xl font-w mb-2'>What is the purpose of JWT? </h3>
                ...
                <h3 className='text-2xl font-w mb-2'>how does JWT work? </h3>
                <p>
            ...
            <div className='blog-items my-5 bg-success  text-white py-5 px-5'>
            <h3 className='text-2xl font-w mb-2'>When should you use 'nodejs' and when should you use 'mongodb'?</h3>
                <p>
